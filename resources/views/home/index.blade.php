                                ...
                                <li data-transition="boxfade" data-slotamount="20" class="active-revslide"
                                    ...
                                    <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined"
                                        ...
                                        <div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover"
                                            ...
                                            src="{{ asset('assets/dest/images/slide/' . $slide->image) }}"
                                            data-src="{{ asset('assets/dest/images/slide/' . $slide->image) }}"
                                            style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('{{ asset('assets/dest/images/slide/' . $slide->image) }}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
                                        </div>
                                    </div>
                                </li>
                            @endforeach
