<div id="header">
	...
	<div class="header-body">
		<div class="container beta-relative">
			<div class="pull-left">
				<a href="{{ url('/') }}" id="logo"><img src="{{ asset('assets/dest/images/logo-cake.png') }}" width="200px" alt=""></a>
			</div>
			...
			<nav class="main-menu">
				<ul class="l-inline ov">
					...
					<li><a href="{{ route('products.index') }}">Sản phẩm</a>
						<ul class="sub-menu">
							<li><a href="{{ route('products.index') }}">Sản phẩm 1</a></li>
							<li><a href="{{ route('products.index') }}">Sản phẩm 2</a></li>
							<li><a href="{{ route('products.index') }}">Sản phẩm 4</a></li>
						</ul>
					</li>
