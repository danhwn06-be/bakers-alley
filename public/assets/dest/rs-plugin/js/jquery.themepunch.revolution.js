        ...
        if (!container.hasClass("revslider-initialised")) {
            ...
            if (opt.shuffle == "on") {
                ...
                for (
                    ...
                    var it = Math.round(
                        Math.random() *
                            container.find(">ul:first-child >li").length,
                    );
                    container
            ...
            container.find(".tp-scrollbelowslider").on("click", function () {
                ...
                try {
                    off = jQuery("body")
                        .find(opt.fullScreenOffsetContainer)
                        .height();
                } catch (e) {}
                try {
...
********************************/
    ...
    var setBulPos = function (container, opt) {
        ...
        if (
            ...
            if (opt.soloArrowLeftValign == "center")
                tl.css({
                    top: "50%",
                    marginTop:
                        opt.soloArrowLeftVOffset -
                        Math.round(tl.innerHeight() / 2) +
                        "px",
                });
            ...
            if (opt.soloArrowRightValign == "center")
                tr.css({
                    top: "50%",
                    marginTop:
                        opt.soloArrowRightVOffset -
                        Math.round(tr.innerHeight() / 2) +
                        "px",
                });
        ...
        if (opt.navigationVAlign == "center")
            bullets.css({
                top: "50%",
                marginTop:
                    opt.navigationVOffset -
                    Math.round(bullets.innerHeight() / 2) +
                    "px",
            });
    ...
    var handleSpecialPreviews = function (opt) {
        ...
        var comingli = container.find(
            ...
            beforli = container.find(
                ">ul:first-child >li:eq(" + opt.beforli + ")",
            ),
        ...
        if (rar.hasClass("itishovered")) {
            rar.width(
                ratit.outerWidth(true) + parseInt(rar.css("minWidth"), 0),
            );
        }

        if (lar.hasClass("itishovered")) {
            lar.width(
                latit.outerWidth(true) + parseInt(lar.css("minWidth"), 0),
            );
        }
    ...
    var swapSlide = function (container, opt) {
        try {
            var actli = container.find(
                ">ul:first-child >li:eq(" + opt.act + ")",
            );
        } catch (e) {
        ...
        if (
            ...
            if (!isIE(8))
                defimg.css({
                    backgroundImage:
                        'url("' +
                        nextli.find(".defaultimg").data("lazyload") +
                        '")',
                });
            else {
            ...
            actsh.find(".slotslide").each(function (j) {
                ...
                mtl.add(
                    punchgs.TweenLite.to(ss, 0.1, {
                        ...
                        delay:
                            (j * 50) / 1000 +
                            (masterspeed / 1000 - masterspeed / 10000),
                    }),
                    0,
                );
            });
    ...
    var animateTheCaptions = function (nextli, opt, recalled, mtl) {
        ...
        allcaptions.each(function (i) {
            ...
            if (
                ...
                offsety =
                    opt.container.height() / 2 - (opt.startheight * opt.bh) / 2;
            ...
            if (handlecaption == 0) {
                ...
                if (
                    ...
                    var frameID =
                            "iframe" + Math.round(Math.random() * 100000 + 1),
                    ...
                    nextcaption.find("iframe").each(function () {
                        ...
                        if (
                            ifr.attr("src").toLowerCase().indexOf("youtube") >=
                            0
                        ) {
                            ...
                            ifr.attr("src").toLowerCase().indexOf("vimeo") >= 0
                        ) {
                    ...
                    if (
                        is_mobile() &&
                        nextcaption.data("disablevideoonmobile") == 1
                    )
                            ...
                            html5vid.data(
                                ...
                                setInterval(function () {
                                    if (
                                        ...
                                        opt.nextslideatend =
                                            nextcaption.data("nextslideatend");
                ...
                if (nextcaption.find("img").length > 0) {
                    ...
                    if (
                        ...
                        if (nc.data("bt") == undefined)
                            nc.data(
                                "bt",
                                parseInt(nc.css("borderTop"), 0) || 0,
                            );
                        if (nc.data("bb") == undefined)
                            nc.data(
                                "bb",
                                parseInt(nc.css("borderBottom"), 0) || 0,
                            );
                        if (nc.data("bl") == undefined)
                            nc.data(
                                "bl",
                                parseInt(nc.css("borderLeft"), 0) || 0,
                            );
                        if (nc.data("br") == undefined)
                            nc.data(
                                "br",
                                parseInt(nc.css("borderRight"), 0) || 0,
                            );
                ...
                if (
                    nextcaption.data("timeline") != undefined &&
                    !internrecalled
                ) {
    ...
    var callCaptionLoops = function (nextcaption, factor) {
        ...
        nextcaption.find(".rs-wave").each(function () {
            ...
            if (el.data("timeline") == undefined) {
                ...
                var angle =
                        el.data("angle") == undefined ? 10 : el.data("angle"),
                    radius =
                        el.data("radius") == undefined ? 10 : el.data("radius"),
                    speed =
    ...
    var endMoveCaption = function (
        ...
        if (
            ...
            backwards.delay = 0;
            tl.add(
                punchgs.TweenLite.to(nextcaption, mspeed, backwards),
                mdelay,
            );
        }
        ...
        if (
            ...
            container.on("starttimer", function () {
                if (
                    ...
                    if (
                        (opt.stopLoop == "on" &&
                            opt.next == opt.lastslidetoshow - 1) ||
                        opt.noloopanymore == 1
                    ) {
                        opt.noloopanymore = 1;
                    } else {
                        ...
                        },
                        {
                            ...
                            onUpdate: function () {
                                ...
                                var ww = sx * kbimg.width() - opt.width,
                                    hh = sx * kbimg.height() - opt.height,
                                    hor = Math.abs(
                                        (kbimg[0]._gsTransform.x / ww) * 100,
                                    ),
                                    ver = Math.abs(
                                        (kbimg[0]._gsTransform.y / hh) * 100,
                                    );
                                if (hh == 0) ver = 0;
                                if (ww == 0) hor = 0;
	...
	**************************************************/
    ...
    var calculateKenBurnImgPos = function (opt, bgp, bgf, img, turned) {
        ...
        switch (bgp) {
            ...
            case "top center":
                imgobj.x =
                    ((0 - img.width()) * imgobj.w + parseInt(opt.width, 0)) / 2;
                imgobj.y = 0;
                break;
            case "top right":
            case "right top":
                imgobj.x =
                    (0 - img.width()) * imgobj.w + parseInt(opt.width, 0);
                imgobj.y = 0;
            ...
            case "left center":
                imgobj.x = 0;
                imgobj.y =
                    ((0 - img.height()) * imgobj.w + parseInt(opt.height, 0)) /
                    2;
                break;
            case "center center":
                imgobj.x =
    ...
    var checkForParallax = function (container, opt) {
        ...
        if (
            ...
            container.on(
                "mousemove.hoverdir, mouseleave.hoverdir",
                function (event) {
                    var currslide = container.find(".current-sr-slide-visible");
                    switch (event.type) {
                        case "mousemove":
