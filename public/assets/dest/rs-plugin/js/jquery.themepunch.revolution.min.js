...
(function (e, t) {
    ...
    var m = function (t, n) {
        ...
        if (n.navigationInGrid == "on") {
            ((f =
                t.width() > n.startwidth ? (t.width() - n.startwidth) / 2 : 0),
                (l =
    ...
    var I = function (n, r, i, s) {
        ...
        f.each(function (n) {
            ...
            if (d == 0) {
                if (
                    f.data("linktoslide") != t &&
                    !f.hasClass("hasclicklistener")
                ) {
                ...
                if (f.find("img").length > 0) {
                    ...
                    if (
                        ...
                        if (R.data("pb") == t)
                            R.data(
                                "pb",
                                parseInt(R.css("paddingBottom"), 0) || 0,
                            );
                        if (R.data("pl") == t)
                            R.data(
                                "pl",
                                parseInt(R.css("paddingLeft"), 0) || 0,
                            );
                        if (R.data("pr") == t)
                            R.data(
                                "pr",
                                parseInt(R.css("paddingRight"), 0) || 0,
                            );
                        if (R.data("mt") == t)
                        ...
                        if (R.data("mb") == t)
                            R.data(
                                "mb",
                                parseInt(R.css("marginBottom"), 0) || 0,
                            );
                        if (R.data("ml") == t)
                        ...
                        if (R.data("mr") == t)
                            R.data(
                                "mr",
                                parseInt(R.css("marginRight"), 0) || 0,
                            );
                        if (R.data("bt") == t)
                        ...
                        if (R.data("bb") == t)
                            R.data(
                                "bb",
                                parseInt(R.css("borderBottom"), 0) || 0,
                            );
                        if (R.data("bl") == t)
                        ...
                        if (R.data("br") == t)
                            R.data(
                                "br",
                                parseInt(R.css("borderRight"), 0) || 0,
                            );
                        if (R.data("lh") == t)
                        ...
                        f.find(".tp-resizeme, .tp-resizeme *").each(
                            function () {
                                U(e(this), r);
                            },
                        );
                ...
                if (!s) {
                        ...
                        if (f.find("a").length > 0)
                            ...
                            f.data(
                                ...
                                new punchgs.SplitText(
                                    f.find(".tp-layer-inner-rotation"),
                                    {
                                        type: "lines,words,chars",
                                        charsClass: "tp-splitted",
                                        wordsClass: "tp-splitted",
                    ...
                    if (o != 2) {
                        if (f.hasClass("customin")) {
                            ...
                            pt.force3D = "auto";
                            lt.add(
                                vt.staggerFromTo(ct, st, ht, pt, dt),
                                "frame0",
                            );
                        } else {
