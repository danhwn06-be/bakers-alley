            ...
            var h,
                ...
                Z = function (t, e) {
                    ...
                    if ((e = e || q(t, null)))
                        if ((i = e.length))
                            for (; --i > -1; )
                                s[e[i].replace(S, R)] = e.getPropertyValue(
                                    e[i],
                                );
                ...
                me("backgroundPosition", {
                    ...
                    parser: function (t, e, i, r, n, a) {
                        ...
                        if (
                            (-1 !== m.indexOf("%")) !=
                                (-1 !== g.indexOf("%")) &&
                            ((p = H(t, "backgroundImage").replace(k, "")),
                            p && "none" !== p)
                        ) {
                            for (
                                o = m.split(" "),
            ...
            ((l = a.prototype),
                ...
                (l._enableTransforms = function (t) {
                    ((this._transformType =
                        ...
                        (this._transform =
                            this._transform || Pe(this._target, s, !0)));
                }));
            var Me = function () {
                ...
                for (P = !D || (!R && !A), f = 0; k.length > f; f++) {
                    for (
                        ...
                        "BR" !== l[d].nodeName &&
                            ...
                            P &&
                                (y._wordEnd || R) &&
                                w.appendChild(n.createTextNode(" ")),
                            D &&
                                (0 === d &&
                                    ((w.style.top = y._y + "px"),
                                    (w.style.left = z + T + "px")),
