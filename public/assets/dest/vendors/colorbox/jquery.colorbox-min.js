            ...
            "nofollow" !== B.rel &&
                ((k = e("." + et).filter(function () {
                    var t,
                        i = e.data(this, Y);
                    return (
                        i && (t = e(this).data("rel") || i.rel || this.rel),
                        t === B.rel
                    );
                })),
                (z = k.index(N)),
                            ...
                            .one("load", function () {
                                ...
                                f === at &&
                                    ...
                                    B.retinaImage &&
                                        ...
                                        ((j.height =
                                            j.height / i.devicePixelRatio),
                                        (j.width =
                                            j.width / i.devicePixelRatio)),
                                    B.scalePhotos &&
                                        ((r = function () {
                                            ((j.height -= j.height * t),
                                                (j.width -= j.width * t));
                                        ...
                                        B.mw &&
                                            j.width > B.mw &&
                                            ((t = (j.width - B.mw) / j.width),
                                            r()),
                                        B.mh &&
                                            j.height > B.mh &&
                                            ((t = (j.height - B.mh) / j.height),
                                            r())),
                                    B.h &&
                                        (j.style.marginTop =
                                            Math.max(B.mh - j.height, 0) / 2 +
                                            "px"),
                                    k[1] &&
                                        (B.loop || k[z + 1]) &&
                            ...
                            o
                                .each(function () {
                                    e.data(
                                        this,
                                        Y,
                                        e.extend({}, e.data(this, Y) || X, t),
                                    );
                                })
                                .addClass(et),
                            ((e.isFunction(t.open) && t.open.call(o)) ||
                                t.open) &&
                                u(o[0]));
                    }
                    return o;
                        ...
                        U &&
                            ...
                            a > 1
                                ? ("string" == typeof B.current &&
                                  ...
                                  R[
                                      B.loop || a - 1 > z ? "show" : "hide"
                                  ]().html(B.next),
                                  I[B.loop || z ? "show" : "hide"]().html(
                                      B.previous,
                                  ),
                                  ct(),
                                  B.preloading &&
