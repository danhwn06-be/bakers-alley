...
(function ($, document, window) {
        ...
        if (!closing) {
            ...
            if (settings.rel !== "nofollow") {
                $related = $("." + boxElement).filter(function () {
                    ...
                    if (data) {
                        relRelated =
                            $(this).data("rel") || data.rel || this.rel;
                    }
    ...
    publicMethod.prep = function (object) {
        ...
        callback = function () {
            ...
            if (total > 1) {
                ...
                $next[
                    settings.loop || index < total - 1 ? "show" : "hide"
                ]().html(settings.next);
    ...
    function load() {
        ...
        if (settings.maxWidth) {
            ...
            settings.mw =
                settings.w && settings.w < settings.mw
                    ? settings.w
                    : settings.mw;
        }
        if (settings.maxHeight) {
            settings.mh =
                setSize(settings.maxHeight, "y") -
                loadedHeight -
                interfaceHeight;
            settings.mh =
                settings.h && settings.h < settings.mh
                    ? settings.h
                    : settings.mh;
        }
