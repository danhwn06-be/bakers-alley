...
mejs.MediaFeatures = {
    init: function () {
        ...
        a.hasMozNativeFullScreen =
            typeof e.mozRequestFullScreen !== "undefined";
...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function (a, b, c, d, e, g) {
        ...
        for (
            m = c.parentNode;
            m !== null && m.tagName.toLowerCase() != "body";
        ) {
            ...
            },
            {
                ...
                action: function (a, b) {
                    if (!isNaN(b.duration) && b.duration > 0) {
                        ...
                        var c = Math.max(
                            b.currentTime -
                                a.options.defaultSeekBackwardInterval(b),
                            0,
                        );
                        b.setCurrentTime(c);
                    }
            ...
            },
            {
                ...
                action: function (a, b) {
                    if (!isNaN(b.duration) && b.duration > 0) {
                        ...
                        var c = Math.min(
                            b.currentTime +
                                a.options.defaultSeekForwardInterval(b),
                            b.duration,
                        );
                        b.setCurrentTime(c);
                    }
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function () {
            ...
            if (
                ...
                b.isiPad &&
                    a.media.getAttribute("autoplay") !== null &&
                    a.play();
        ...
        setPlayerSize: function (a, b) {
            ...
            if (
                ...
                c =
                    this.isVideo || !this.options.autosizeProgress
                        ...
                        : e;
                if (
                    this.container.parent()[0].tagName.toLowerCase() === "body"
                ) {
                    d = f(window).width();
                    c = f(window).height();
                }
            ...
            c.css(
                "margin-top",
                "-" +
                    (c.height() / 2 - this.controls.height() / 2).toString() +
                    "px",
            );
        },
            ...
            if (a.isVideo) {
                ...
                e.addEventListener(
                    ...
                    function () {
                        ...
                        b.find(".mejs-time-buffering").hide();
                        k.show();
                        k.find("mejs-overlay-error").html(
                ...
                e.addEventListener(
                    ...
                    function () {
                        if (!l)
                            if (e.muted) {
                                t(0);
                                k.removeClass("mejs-mute").addClass(
                                    "mejs-unmute",
                                );
                            } else {
                                t(e.volume);
                                k.removeClass("mejs-unmute").addClass(
                                    "mejs-mute",
                                );
                            }
                    },
    ...
    f.extend(MediaElementPlayer.prototype, {
            ...
            if (a == "none") {
                ...
                for (b = 0; b < this.tracks.length; b++)
                    if (this.tracks[b].srclang == a) {
                        this.selectedTrack == null &&
                            this.captionsButton.addClass(
                                "mejs-captions-enabled",
                            );
        ...
        drawChapters: function (a) {
            ...
            for (c = 0; c < a.entries.times.length; c++) {
                ...
                if (
                    e + d > 100 ||
                    (c == a.entries.times.length - 1 && e + d < 100)
                )
                    e = 100 - d;
                b.chapters.append(
                    f(
            ...
            parse: function (a) {
                ...
                for (var c = { text: [], times: [] }, e, d; b < a.length; b++)
                    if (this.pattern_identifier.exec(a[b])) {
                        b++;
                        if (
                            (e = this.pattern_timecode.exec(a[b])) &&
                            b < a.length
                        ) {
                            b++;
                            d = a[b];
                            ...
                            c.times.push({
                                start:
                                    ...
                                    0
                                        ? 0.2
                                        : mejs.Utility.convertSMPTEtoSeconds(
                                              e[1],
                                          ),
